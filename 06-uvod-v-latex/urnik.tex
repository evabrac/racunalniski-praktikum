...
\begin{itemize}
   \item \emph{Razred} /Profesor/ vsebuje osebne podatke profesorja (ime in priimek) ter
   ...
   \item \emph{Razred} /Skupina/ predstavlja skupino študentov. Kot podatke torej potrebujemo
   ...
   \item \emph{Razred} /Predavalnica/ nosi podatke o kapaciteti predavalnice, njeno oznako
   ter podatke o zasedenosti, ki so predstavljeni s tabelo.

   \item \emph{Razred} /Predmet/ vsebuje podatke o posameznih predmetih. Kot podatke tega
...
kakovost urnika:
\[
k_1 \cdot u_1 + k_2 \cdot u_2 + k_3 \cdot u_3 + \dots + k_m \cdot u_m
\]
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   Za vse proste termine $predavalnica_j$ izračunamo ceno vstavljanja
